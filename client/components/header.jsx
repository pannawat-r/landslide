                ...
                <div className="my-auto">
                    <div className="flex justify-between ">
                        ...
                        <div className="relative inline-block mx-1">
                            <button type="button" className={`flex items-center hover:text-black ${pathname == '/angkhang' ? "text-black" : "text-gray-500"} `} onClick={toggleDropdown}>ติดตามสถานการณ์ดินถล่ม
